        ...
        <form action="contact.php" class="form-stacked" method="post">
            ...
            <input type="hidden" id="uaHash" name="uaHash" value="<?php echo $ua->uaHash?>">
            <fieldset>
                ...
                <div class="clearfix">
                    ...
                    ?>
                    <textarea class="xxlarge" id="message" name="message" rows="8"><?php echo $salutations[$randKey]?>-

I may have found a problem with the browser related to the user agent hash "<?php echo $_REQUEST['cid']?>." My notes are below:
