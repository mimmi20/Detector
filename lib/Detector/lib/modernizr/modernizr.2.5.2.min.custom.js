...
window.Modernizr = function (a, b, c) {
    ...
    var d = "2.5.2", e = {}, f = b.documentElement, g = "modernizr", h = b.createElement(g), i = h.style, j = b.createElement("input"), k = ":)", l = {}.toString, m = " -webkit- -moz- -o- -ms- ".split(" "), n = "Webkit Moz O ms", o = n.split(" "), p = n.toLowerCase().split(" "), q = {}, r = {}, s = {}, t = [], u = t.slice, v, w = function (a, c, d, e) {
    ...
    }(['@font-face {font-family:"font";src:url("https://")}', ["@media (", m.join("touch-enabled),("), g, ")", "{#touch{top:9px;position:absolute}}"].join(""), ["@media (", m.join("transform-3d),("), g, ")", "{#csstransforms3d{left:9px;position:absolute;height:3px;}}"].join(""), ['#generatedcontent:after{content:"', k, '";visibility:hidden}'].join("")], ["fontface", "touch", "csstransforms3d", "generatedcontent"]);
    q.flexbox = function () {
        return H("flexOrder")
    }, q.canvas = function () {
    ...
    for (var K in q)A(q, K) && (v = K.toLowerCase(), e[v] = q[K](), t.push((e[v] ? "" : "no-") + v));
    return e.input || J(), e.addTest = function (a, b) {
        ...
        return e
    }, B(""), h = j = null, e._version = d, e._prefixes = m, e._domPrefixes = p, e._cssomPrefixes = o, e.mq = x, e.hasEvent = y, e.testProp = function (a) {
        return F([a])
    }, e.testAllProps = H, e.testStyles = w, e.prefixed = function (a, b, c) {
        return b ? H(a, b, c) : H(a, "pfx")
    }, e
}(this, this.document), Modernizr.addTest("adownload", "download"in document.createElement("a")), Modernizr.addTest("lowbattery", function () {
    var a = .2, b = Modernizr.prefixed("battery", navigator);
    return!!(b && !b.charging && b.level <= a)
}), Modernizr.addTest("contenteditable", "isContentEditable"in document.documentElement), Modernizr.addTest("webaudio", !!window.webkitAudioContext || !!window.AudioContext), Modernizr.addTest("audiodata", !!window.Audio), Modernizr.addTest("cookies", function () {
...
}), Modernizr.addTest("battery", !!Modernizr.prefixed("battery", navigator)), function () {
    function a(a) {
    ...
    return el = document.createElement("div"), el.style.cssText = Modernizr._prefixes.join("transition-timing-function:cubic-bezier(1,0,0,1.1); "), !!el.style.length
}), Modernizr.addTest("overflowscrolling", function () {
    return Modernizr.testAllProps("overflowScrolling")
}), Modernizr.addTest("mediaqueries", Modernizr.mq("only all")), Modernizr.addTest("cssremunit", function () {
...
}), Modernizr.addTest("cssresize", Modernizr.testAllProps("resize")), Modernizr.addTest("cssscrollbar", function () {
...
}), Modernizr.addTest("dataview", typeof DataView != "undefined" && "getFloat64"in DataView.prototype), Modernizr.addTest("microdata", !!document.getItems), Modernizr.addTest("progressbar", function () {
...
}), Modernizr.addTest("time", "valueAsDate"in document.createElement("time")), Modernizr.addTest("pointerevents", function () {
...
}), Modernizr.addTest("devicemotion", "DeviceMotionEvent"in window), Modernizr.addTest("deviceorientation", "DeviceOrientationEvent"in window), Modernizr.addTest("speechinput", function () {
    var a = document.createElement("input");
    return"speech"in a || "onwebkitspeechchange"in a
}), Modernizr.addTest("filereader", function () {
    return!!(window.File && window.FileList && window.FileReader)
}), Modernizr.addTest("filesystem", function () {
    var a = Modernizr._domPrefixes;
    for (var b = -1, c = a.length; ++b < c;)if (window[a[b] + "RequestFileSystem"])return!0;
...
}), Modernizr.addTest("gamepad", "gamepads"in navigator), function () {
    var a = new Image;
    a.onerror = function () {
...
}(), Modernizr.addTest("json", !!window.JSON && !!JSON.parse), Modernizr.addTest("lowbandwidth", function () {
    var a = navigator.connection || {type: 0};
    return a.type == 3 || a.type == 4 || /^[23]g$/.test(a.type)
}), Modernizr.addTest("eventsource", !!window.EventSource), Modernizr.addTest("notification", !!Modernizr.prefixed("Notifications", window)), Modernizr.addTest("performance", !!Modernizr.prefixed("performance", window)), Modernizr.addTest("quotamanagement", function () {
    var a = Modernizr.prefixed("StorageInfo", window);
    return!!(a && "TEMPORARY"in a && "PERSISTENT"in a)
}), Modernizr.addTest("scriptasync", "async"in document.createElement("script")), Modernizr.addTest("scriptdefer", "defer"in document.createElement("script")), Modernizr.addTest("unicode", function () {
...
}), Modernizr.addTest("websocketsbinary", !!window.WebSocket && !!(new WebSocket("ws://.")).binaryType), function () {
    try {
        ...
        var e = b.createObjectURL(d.getBlob());
        worker = new Worker(e), d = null, worker.onmessage = function (a) {
            worker.terminate(), b.revokeObjectURL(e), Modernizr.addTest("blobworkers", c === a.data), worker = null
        }, worker.onerror = function () {
            Modernizr.addTest("blobworkers", !1), worker = null
        }, setTimeout(function () {
            Modernizr.addTest("blobworkers", !1)
        }, 200), worker.postMessage(c)
    } catch (f) {
        Modernizr.addTest("blobworkers", !1)
    }
    ...
    try {
        ...
        b.onmessage = function (c) {
            b.terminate(), Modernizr.addTest("dataworkers", a === c.data), b = null
        }, b.onerror = function () {
